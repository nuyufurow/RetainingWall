function [ M ] = neilijisuan01( E,A,I,k,f,n,Q,H )
...
elseif n==2
                                  ...
                                  %支反力修正为真正结构的支反力，令F+结构全部加上刚臂时的节点反力，得到真正结构的内力和支反力
k01=PlaneFrameElementStiffness(E(1),A(1),I(1),H(1));%得到单元1的单元刚度矩阵
F01=k01*[0;0;0;u(1);0;u(2)];                        %得到1单元各节点内力
k02=PlaneFrameElementStiffness(E(1),A(2),I(2),H(2));%得到单元2的单元刚度矩阵
F02=k02*[u(1);0;u(2);u(3);0;u(4)];                  %得到2单元各节点内力
...
F03=k03*[u(3);0;u(4);u(5);0;u(6)];                        %得到3单元各节点内力                                               
...
F04=k04*[u(5);0;u(6);u(7);0;u(8)];                        %得到4单元各节点内力
